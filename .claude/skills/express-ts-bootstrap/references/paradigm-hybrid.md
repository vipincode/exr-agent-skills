...
The mixing rule must be written explicitly into ARCHITECTURE.md so module-planner and module-builder apply the same decision rule per module rather than guessing. Consistency of *the rule* matters more than uniformity of the output.
