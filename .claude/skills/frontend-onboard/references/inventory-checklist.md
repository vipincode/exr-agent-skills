...
## Tests
- Framework, RTL setup, file convention (colocated `*.test.tsx` vs `__tests__/`), and whether there are component/hook/e2e tests. frontend-test-writer will match this.
